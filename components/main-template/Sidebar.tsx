        ...
        <div className="side-bar-fixed h-full">
          ...
          >
            ...
            <li className="mb-5">
              ...
              ><img src="logout.svg" alt="logout icon" /></Link>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-2 ">
            ...
            <li>
              <Link
                ...
                className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              ><>
              <span className="flex-1 ml-3 whitespace-nowrap">Role</span><svg
                  width="7"
                  height="10"
                  viewBox="0 0 7 10"
                  fill="none"
            ...
            <li>
              <Link
                ...
                className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              ><>
              <span className="flex-1 ml-3 whitespace-nowrap">Users</span><svg
                  width="7"
                  height="10"
                  viewBox="0 0 7 10"
                  fill="none"
